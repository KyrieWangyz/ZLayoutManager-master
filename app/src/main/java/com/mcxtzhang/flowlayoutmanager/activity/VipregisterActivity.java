...
public class VipregisterActivity extends AppCompatActivity implements View.OnClickListener,VipResgisterContract.View{
    private String code;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_vip_layout);
