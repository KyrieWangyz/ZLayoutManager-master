...
public class SeconfvipFragment extends Fragment implements IpInfoContract.View_SearchByCoach ,View.OnClickListener,IpInfoContract.View_Postmessage{
...
//        mpresenter.getIpInfo(null, string);
    ...
    public void setIpInfo(PostMessageInfo ipInfo) {
        Toast.makeText(getActivity(),ipInfo.msg,Toast.LENGTH_SHORT);
    }
    ...
    public void showError() {
        Toast.makeText(getActivity().getApplicationContext(),"有错误",Toast.LENGTH_SHORT).show();;
    }
