...
public class CoachPresenter implements VipResgisterContract.Presenter,LoadTaskCallBack<VipResgisterInfo> {
    private NetTask1 netTask;
    private VipResgisterContract.View addTaskView;
    public CoachPresenter(VipResgisterContract.View addTaskView,NetTask1 netTask){
