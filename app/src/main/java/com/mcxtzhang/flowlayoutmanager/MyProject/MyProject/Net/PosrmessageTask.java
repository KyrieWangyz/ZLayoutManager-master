...
public class PosrmessageTask implements NetTask<String> {
    private static PosrmessageTask INSTANCE=null;
    ...
    private PosrmessageTask(){
    }
    public static PosrmessageTask getINSTANCE(){
        if(INSTANCE==null)
        {
            INSTANCE=new PosrmessageTask();
        }
        return  INSTANCE;
    }
