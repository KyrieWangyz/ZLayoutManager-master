...
public class CancelPresenter implements IpInfoContract.Presenter,LoadTaskCallBack<PostMessageInfo> {
    private NetTask netTask;
    private IpInfoContract.View_Postmessage addTaskView;
    public CancelPresenter(IpInfoContract.View_Postmessage addTaskView,NetTask netTask){
