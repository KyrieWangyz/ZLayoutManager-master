...
public class OverLayCardLayoutManager extends RecyclerView.LayoutManager {
    ...
    @Override
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {//它相当于ViewGroup的onLayout()方法
        Log.e(TAG, "onLayoutChildren() called with: recycler = [" + recycler + "], state = [" + state + "]");
        detachAndScrapAttachedViews(recycler);//把原先的recycler删除掉
